...
function showDppModal(productId) {
      ...
      '<div class="dpp-passport-body">' +
        ...
        '<div class="dpp-passport-col">' +
          ...
          '<div class="dpp-passport-card">' +
            ...
            '<div id="dpp-climatiq-lca" style="background: rgba(91, 116, 83, 0.05); border: 1px solid rgba(91, 116, 83, 0.15); border-radius: 8px; padding: 12px; font-size: 0.78rem; text-align: left; margin-bottom: 14px; color: var(--foreground); line-height: 1.4;">' +
              '<div style="text-align: center; color: var(--text-muted);"><i class="fa-solid fa-circle-notch fa-spin"></i> ' + (isEn ? 'Fetching Climatiq LCA Data...' : 'Đang tải dữ liệu LCA từ Climatiq...') + '</div>' +
            '</div>' +
          ...
          '<div class="dpp-passport-card">' +
            ...
            '<div id="dpp-os-origin" style="font-size: 0.78rem; line-height: 1.45; text-align: left; color: var(--foreground); background: rgba(91, 116, 83, 0.05); border: 1px solid rgba(91, 116, 83, 0.15); border-radius: 8px; padding: 12px; display: flex; align-items: flex-start; gap: 10px;">' +
              '<div style="width: 100%; text-align: center; color: var(--text-muted);"><i class="fa-solid fa-circle-notch fa-spin"></i> ' + (isEn ? 'Fetching Origin Data...' : 'Đang xác thực nguồn gốc...') + '</div>' +
            '</div>' +
          '</div>' +
  ...
  // Trigger async API fetches
  fetchClimatiqEmission(dpp, isEn);
  fetchSupplyHubFacilities(dpp, isEn);
}
